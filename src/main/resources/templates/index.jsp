...
<div class="navbar navbar-default" id="subnav">
    <div class="col-md-12">
        <div class="navbar-header">
            ...
            <button class="navbar-toggle" data-target="#navbar-collapse2" data-toggle="collapse"
                    type="button">
        ...
        <div class="panel panel-default qna-list">
                    ...
                    <div class="wrap">
                        <div class="main">
                            ...
                            <div class="auth-info">
                                ...
                                <a class="author" href="./user/profile.html">자바지기</a>
                            </div>
                    ...
                    <div class="wrap">
                        <div class="main">
                            ...
                            <div class="auth-info">
                                ...
                                <a class="author" href="./user/profile.html">김문수</a>
                            </div>
                            <div class="reply" title="댓글">
                                <i class="icon-reply"></i>
            ...
            <div class="row">
                ...
                <div class="col-md-3 qna-write">
                    <a class="btn btn-primary pull-right" href="./qna/form.html" role="button">질문하기</a>
                </div>
            </div>
        </div>
    </div>
